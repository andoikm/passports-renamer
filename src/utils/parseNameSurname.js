...
/**
 * Parse "Surname" / "Given Name" (or "First Name") labels from OCR text.
...
/**
 * Sanitize for filename: lowercase, only letters/numbers/dots/dashes.
 * @param {string} s
 * @returns {string}
 */
...
/**
 * Build renamed filename: name.surname.pdf
 */
export function buildRenamedFilename(name, surname) {
